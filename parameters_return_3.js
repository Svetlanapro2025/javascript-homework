function getMessageStats(allMessages) {
  let editedMessages = 0;
  let notEditedMessages = 0;
  let allCountMessages = allMessages.length;
...
return {
  edit: editedMessages,
  notEdit: notEditedMessages,
  all: allCountMessages
};
}
